...
<head>
    ...
    <title>Daftar - Mari Sehat Selalu</title>
...
<body class="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <!-- Card -->
        <div class="bg-white rounded-2xl shadow-xl p-8" x-data="{ showPass: false, showPassConf: false }">
            <h2 class="text-xl font-semibold text-gray-800 mb-1">Buat Akun Baru</h2>
            <p class="text-gray-400 text-sm mb-6">Daftar sebagai pasien untuk membuat janji temu</p>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                            ...
                            class="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-green-400 focus:border-transparent outline-none transition @error('name') border-red-400 bg-red-50 @enderror">
                    </div>
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input id="password_confirmation" :type="showPassConf ? 'text' : 'password'"
                            ...
                            class="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-green-400 focus:border-transparent outline-none transition">
                ...
                <!-- Info -->
                <div class="mb-5 bg-green-50 border border-green-200 rounded-xl px-4 py-3 flex items-start gap-2">
                    <svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    <p class="text-green-700 text-xs">
                        Pendaftaran ini untuk akun <strong>pasien</strong>. Untuk akun dokter atau apoteker, hubungi admin klinik.
                    </p>
                </div>
